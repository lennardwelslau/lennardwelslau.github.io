...
\section{Work Experience}
    \Subheading
        ...
        {Research Analyst -- Data analysis, visualization, automation, economic modelling, co-authored various publications (macroeconomics, EU governance, trade), presented research externally (Python, R, Excel)}{}
...
%     \Subheading
%       {Kritiske Politter}{, Copenhagen, Denmark}{09/2019 – 09/2020}
%       {Economics reading circles, invited speaker seminars}

%     \Subheading
%       {TriRhena Consulting}{, Freiburg, Germany}{04/2015 – 08/2016}
%       {Social network analysis, balance sheet analysis}

%     \Subheading
%     {Geneva Model United Nations}{, Geneva, Switzerland}{04/2015 – 09/2015}
%     {MUN Delegate to the Legal Committee}

%     \Subheading
%       {University College Freiburg Student Council}{, Freiburg, Germany}{10/2014 – 08/2016}
%       {Student representative in the Committee of Outreach}

%     \Subheading
%       {Sonati}{, Estelí, Nicaragua}{09/2013}
%       {Volunteer with environmental education non-profit}

%     \Subheading
%        {FT 1844 Freiburg e.V.}{, Freiburg, Germany}{07/2009 – 08/2018}
